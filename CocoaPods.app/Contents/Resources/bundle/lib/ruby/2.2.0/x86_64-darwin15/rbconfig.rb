...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/orta/dev/mac/CocoaPods-app/destroot/bundle")
  ...
  CONFIG["configure_args"] = " '--prefix' '/Users/orta/dev/mac/CocoaPods-app/destroot/bundle' '--enable-load-relative' '--disable-shared' '--with-static-linked-ext' '--disable-install-doc' '--without-ext=,dbm,gdbm,sdbm,dl/win32,fiddle/win32,tk/tkutil,tk,win32ole,-test-/win32/dln,-test-/win32/fd_setsize,-test-/win32/dln/empty' 'CC=/usr/bin/clang' 'CFLAGS=-mmacosx-version-min=10.10 -isysroot /Applications/Xcode7.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk' 'LDFLAGS=-L/Users/orta/dev/mac/CocoaPods-app/destroot/dependencies/lib' 'CPPFLAGS=-I/Users/orta/dev/mac/CocoaPods-app/destroot/dependencies/include' 'CXX=/usr/bin/clang++'"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/orta/dev/mac/CocoaPods-app/destroot/dependencies/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/orta/dev/mac/CocoaPods-app/destroot/dependencies/lib -fstack-protector -L/usr/local/lib"
  CONFIG["CFLAGS"] = "-mmacosx-version-min=10.10 -isysroot /Applications/Xcode7.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.11.sdk -pipe"
