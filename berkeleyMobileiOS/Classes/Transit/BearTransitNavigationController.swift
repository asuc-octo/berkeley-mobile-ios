...
class BearTransitNavigationController: UINavigationController, IBInitializable {
    ...
    private func preparePageTabBarItem() {
        pageTabBarItem.image = #imageLiteral(resourceName: "beartransit")
...
//        pageTabBarItem.image = #imageLiteral(resourceName: "beartransitColoredIcon").withRenderingMode(.alwaysOriginal)
