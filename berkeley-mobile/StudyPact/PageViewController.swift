...
class PageViewController: UIPageViewController, UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    let closeButton: UIButton = {
        ...
        button.setTitleColor(.gray, for: .normal)
        button.addTarget(self, action: #selector(closeClicked(_:)), for: .touchUpInside)
        return button
    }()
    ...
    func configureButtons() {
        ...
        nextButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -5).isActive = true
        ...
        skipButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -5).isActive = true
    ...
    @objc func getStartedClicked(_: UIButton) {
        let vc = NewStudyPactClassOnboardingViewController(transitionStyle: .scroll, navigationOrientation: .horizontal)
        vc.modalPresentationStyle = .fullScreen
        self.present(vc, animated: true, completion: nil)
    }
    
    @objc func closeClicked(_: UIButton) {
    ...
    func configurePageControl() {
        ...
        let page2 = StudyPactOnboardingViewController(_signUpLabelText: "Get Matched", _bearImage: UIImage(named: "Onboarding2")!, _numberImage: UIImage(named: "Onboarding2Num")!, _descriptionText: "Based on your peferences, we will match you with existing groups or will be marked as pending and notified when you are matched")
        let page3 = StudyPactOnboardingViewController(_signUpLabelText: "Connect", _bearImage: UIImage(named: "Onboarding3")!, _numberImage: UIImage(named: "Onboarding3Num")!, _descriptionText: "Get connected through your preferred choice of contact and send in-app study notifs!")
